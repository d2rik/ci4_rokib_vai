<div class="flex flex-col lg:flex-row gap-4">
    <div class="w-full lg:w-72 flex-1 border-2 border-sky-600 shadow p-3 rounded">
        ...
        <p class="text-base">
            General Scholarship in Primary Scholarship Examination-2006,
            (5th Grade Level).
        </p>
        ...
        <div class="flex items-center gap-3 mt-3">
            ...
            <span class="text-xs">rokibulme14@gmail.com</span>
        </div>
        <div class="flex items-center gap-3 mt-3">
            ...
            <address class="text-xs">
                Flat 2C (Shikder Apartment), Road No-03 Bhumi Polly
                Residential Area
            </address>
        </div>
    </div>
