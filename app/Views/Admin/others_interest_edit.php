<form action="" method="post">
    ...
    <div class="grid grid-cols-1 gap-4">
        <div class="mb-4">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" name="title" value="<?= $others_interest['title'] ?>">
        </div>
        <div class=" mt-3 mb-4">
            <label class="block text-gray-700 text-sm font-bold mb-2" for="">
                Description
            </label>
            <textarea rows="10" name="description" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"><?= $others_interest['description'] ?></textarea>
        </div>
    </div>
