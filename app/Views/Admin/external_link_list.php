        ...
        <tbody>
            ...
            <?php foreach ($site_info['external_link'] as $row) : ?>
                <tr class='bg-white border-b dark:bg-gray-900 dark:border-gray-700'>
                    ...
                    <td class='px-6 py-4'>
                        <a href="<?= base_url('admin/external_link/') . $row['id'] ?>" class='hover:bg-blue-50 py-2 px-3 rounded-lg font-medium text-blue-600 dark:text-blue-500 hover:underline'>Edit</a>
                    </td>
                    <td class='px-6 py-4'>
