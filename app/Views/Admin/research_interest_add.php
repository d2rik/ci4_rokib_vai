...
<form action="research_interest_add" method="post" enctype="multipart/form-data">
    <?= csrf_field() ?>
    <div class="grid grid-cols-1 gap-4">
        ...
        <div class="mb-4">
            ...
            <input onchange="loadFile(event)" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="file" name="image">
        </div>
        <div class=" mt-3 mb-4">
