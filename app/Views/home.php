...
<div class="mt-16">
    <h1 class="inline font-bold text-md border-b-2 border-primary">FUN FACTS</h1>
        ...
        <div class=""> <!-- fun fact item -->
            <div class=" grid grid-cols-2 lg:grid-cols-3 gap-4">
                <div class="flex px-2 py-10 border flex-col items-center">
                    <div class="p-2">
                        <svg class="w-8 h-8 text-primary" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 20">
...
<div class="mt-16">
    <h1 class="inline font-bold text-md border-b-2 border-primary">QUOTE</h1>
    <div class="border-b mb-2 border-gray-200"></div>
    <div class="px-7 lg:px-12 py-3 lg:py-4">
